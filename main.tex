...
\setbeamertemplate{footline}{\strut~\texttt{https://osf.io/c6m4u/}\hfill\insertframenumber~/~\inserttotalframenumber\strut~~~}
...
\begin{frame}{Beyond compliance: large-scale, synthetic research}
  The same approaches that facilitate transparency and reproducibility support the kind of scalable research that can address archaeological 'grand challenges' \cite{Kintigh2014-ub}.
\end{frame}
